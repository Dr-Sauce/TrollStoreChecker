...
**Note:** TrollStore Checker cannot check whether TrollStore is available on iOS beta versions. Also TrollStore Checker does not work on certain region devices. (Shows wrong result.)
